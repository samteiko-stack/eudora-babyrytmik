...
async function main() {
  try {
    ...
    // Import registrations in batch
    console.log('Importing registrations in batch...');
    const registrationsToCreate = importData.map((reg: any) => ({
      id: reg.id,
    ...
    console.log(`✅ Successfully imported ${importData.length} registrations!`);
